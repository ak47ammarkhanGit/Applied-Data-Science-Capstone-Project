...
def update_scatter_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        # Filter data for successful launches (class == 1)
        ...
        # Create a scatter plot
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Payload Mass vs Launch Outcome at {entered_site}')
